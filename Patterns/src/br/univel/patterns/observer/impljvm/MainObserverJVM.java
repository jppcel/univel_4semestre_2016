 ...
 * Padrão observe é utilizado para dizer que um objeto será observado por outros, estes outros objetos receberão uma notificação de alteração do objeto observado, sempre que este mudar algo no seu status
 * Este exemplo utiliza o padrão disponível com a JVM do java, porém devido a utilizar extends, não é o ideal, é recomendavél que se faça o seu proprio observer
 * </pre>
 * 
 * @author Will
 *
